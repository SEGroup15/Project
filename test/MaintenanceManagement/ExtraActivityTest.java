...
public class ExtraActivityTest {
    ...
    /**
     * Tests of upload method, of class ExtraActivity.
     */
    @Test
    public void testUploadNoWsNoMaterials() throws SQLException {
        a = new ExtraActivity(1, "factTest", "areaTest", "typologyTest", true, null, 10, null);
    ...
    public void testUploadWrongArea() throws SQLException {
        a = new ExtraActivity(1, "factTest", "areaWrong", "typologyTest", true, materials, 10, "wsnotes");
        boolean bool = a.upload(conn);
        assertFalse(bool);
    ...
    public void testUploadWrongMaterials() throws SQLException {
        ...
        materiale.add("HEHE");
        a = new ExtraActivity(1, "factTest", "areaWrong", "typologyTest",  true,materiale , 10, "wsNotes");
        boolean bool = a.upload(conn);
        assertFalse(bool);
    ...
    public void testUploadWrongTypology() throws SQLException {
        a = new ExtraActivity(1, "factTest", "areaTest", "typologyWrong", true, materials, 10, "wsnotes");
        boolean bool = a.upload(conn);
        assertFalse(bool);
    }
    ...
    public void testUploadZeroWeek() throws SQLException {
        a = new ExtraActivity(1, "factTest", "areaTest", "typologyTest", true, materials, 0, "wsnotes");
        boolean bool = a.upload(conn);
        assertFalse(bool);
    ...
    public void testUploadOutOfIntervalWeek() throws SQLException {
        a = new ExtraActivity(1, "factTest", "areaTest", "typologyTest", true, materials, 55, "wsnotes");
        boolean bool = a.upload(conn);
        assertFalse(bool);
    ...
    public void testUploadNegativeWeek() throws SQLException {
        a = new ExtraActivity(1, "factTest", "areaTest", "typologyTest", true, materials, -10, "wsnotes");
        boolean bool = a.upload(conn);
        assertFalse(bool);
        ...
        /**
         * Tests of modify method, of class ExtraActivity.
         */
@Test
    public void TestModify() throws SQLException {
        planner.createActivity("Extra", "factTest", "areaTest", "typologyTest", "description", 0, true, materials, 10, "wsNotes");
        a = (ExtraActivity) planner.getActivity(takeIndex());
        ...
        ResultSet r = op.executeQuery("select name_competence from extra_competence where id = "+ takeIndex());
        r.next();
        rst.next();
