...
public class PlannerGUI extends javax.swing.JFrame {
   ...
   private void setAssignedEWOTable(){
       ...
       int int_random;
        ...
        try{
            while(rst.next()){
                String[] results= Planner.getEWOestime(rst.getString("activityid"));
