...
public class PlannerGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel12.setBounds(379, 266, 135, 14);
        ...
        ExecuteButton.setBounds(709, 350, 125, 50);
        ...
        SiteComboBox.setBounds(88, 242, 188, 28);
        ...
        jScrollPane10.setViewportView(MaterialTable);
        ...
        jScrollPane10.setBounds(370, 310, 250, 140);
    ...
    private void ForwardButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ForwardButtonActionPerformed
        ...
        try {
            /* If the selected activity is an EWO, it will be displayed the list of all maintainer availiabilities for the current day. */
            ...
            /* If the selected activity is not an EWO, it will be displayed the list of all maintainer availiabilities for all the days: to assign an activity 
               to a maintainer in a specific day, the day must be selected. */
            else {
...
//GEN-FIRST:event_MainteinerAvailabilityTableMouseClicked
    ...
    /*
    Initializes some components for the planner maintainance management interface.
    */
    ...
    /*
    Clears all the fields in the PlannerRecordGUI.
    */
    private void clear() {
    ...
    /*
    Initializes the table with the selected maintainer availiability for the selected day in the selected week.
    */
    ...
    /*
    Initializes the table with the updated maintainer availiability for the selected day in the selected week.
    */
    ...
    /*
    Initializes the table with all the maintainer availiabilities for the current day in the current week.
    */
    ...
    /*
    Returns the list of competencies for a specified activity.
    */
    ...
    /*
    Creates a planned activity and inserts it into the database. 
    */
    ...
    /*
    Creates an EWO or extra activity and inserts it into the database. 
    */
    ...
    */
    ...
    /*
    Modify the specified planned activity.
    */
    ...
    /*
    Initializes the site combobox in the PlannerRecordGUI.
    */
    ...
    /*
    Initializes the typology combobox in the PlannerRecordGUI.
    */
    ...
    /*
    Manages the wrong clicks on the availiability table.
    */
    ...
    /*
    Initializes the main table to show all assignable activities (also the partial assigned activities).
    */
    ...
    /*
    Initializes the table with all the maintainer availiabilities for all the days of week (only for planned type activities).
    */   
    ...
    /*
    Initializes the table with all the assigned and partially assigned EWO.
    */   
    ...
    */
    ...
    /*
    Utility method to properly set the PlannerVerificationGUI.
    */
    ...
    */
    ...
    /*
    Utility method to correctly set the MaintainerSelectionGUI label after a day is selected.
    */
    ...
    /*
    Returns "No" if interruptible is false, "Yes" if it's true.
    */
    private String isInterruptible(){
    ...
    /*
    Initializes the EWO competencies list for an EWO activity already partially assigned.
    */
    private void setCompetenciesSkill(JTable tab) throws SQLException {
        ...
        tabskills2.setColumnIdentifiers(new String[]{""});
        while (rst.next()) {
            tabskills2.addRow(new Object[]{rst.getString("name_competence")});
        }
    }
    
    /*
    Used for the initialization of the maintainer selection table with all the maintainer availabilities for the current day in the current week.
    */
    ...
    /*
    Initialized the materials combobox in the PlannerRecordGUI.
    */
    ...
    /*
    Returns true if the activity with the passed id has not yet been assigned.
    */
    private boolean ActivityNotExists(int id) throws SQLException {
    ...
    /*
    Returns the assigned minutes for the activity with the passed ID.
    */
